# Knowledge recovery: can we make the UNLEARNED ck8 model externally output the SUPPRESSED
# answers by reversing the unlearning displacement?  d_S(L) = base_centroid - ck8_centroid
# (correct option, suppressed train split). Steer ck8 model at L_STEER with +alpha*d_S; measure
# K_ext on held-out suppressed. Controls: forgotten (d_F, should NOT recover), random, alpha<0.
...
ax.axvline(0,color="k",lw=.6,ls=":"); ax.axvline(1,color="g",lw=.9,ls="--",label="alpha=1 (full reversal)")
