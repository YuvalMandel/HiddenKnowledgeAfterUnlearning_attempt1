#!/usr/bin/env python3
"""
Task D: Forest plot of suppressed-minus-forgotten mid-layer trajectory AUC
difference per method, with bootstrap 95% CIs and BH-corrected significance.
...
def main():
    ...
    # Sort by effect size (diff) descending for readability
    ...
    ax.set_xlabel("Suppressed − Forgotten  (mid-layer trajectory AUC)", fontsize=11)
    ax.set_title(
