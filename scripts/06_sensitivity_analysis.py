...
from threat_model_analysis_v2_lib import DEFAULT_LABELS_INPUT, DEFAULT_PAIR_DATASET, DEFAULT_TOPIC_INPUT, V2Config, prepare_eligible_outputs, run_sensitivity_outputs
...
def main() -> int:
    ...
    print(config.output_dir / "sensitivity")
    return 0
