...
from threat_model_analysis_v2_lib import DEFAULT_LABELS_INPUT, DEFAULT_PAIR_DATASET, DEFAULT_TOPIC_INPUT, V2Config, run_figures_outputs
...
def main() -> int:
    ...
    print(config.output_dir / "figures")
    return 0
